    ...
    <div className='w-full'>
      ...
      <div>
        <div className='flex gap-10 mb-10 mt-10 border-b-2 border-gray-200 bg-white w-full'>
          <p
            className={`text-xl font-semibold cursor-pointer ${showUserVideos ? activeClass : inactiveClass} mt-2`}
        ...
        <div className='flex gap-6 flex-wrap md:justify-start'>
          {videosList.length ? (
            videosList.map((post: Video) => <VideoCard key={post._id} post={post} />)
          ) : (
